...
@last_update_date)
SET last_update_date=nullif(STR_TO_DATE(@last_update_date,'%m/%d/%Y'),"0000-00-00"),
ant_input_pwr=nullif(@ant_input_pwr,''),
ant_max_pwr_gain=nullif(@ant_max_pwr_gain,''),
antenna_id=nullif(@antenna_id,''),
asrn=nullif(@asrn,''),
aural_freq=nullif(@aural_freq,''),
avg_horiz_pwr_gain=nullif(@avg_horiz_pwr_gain,''),
biased_lat=nullif(@biased_lat,''),
biased_long=nullif(@biased_long,''),
carrier_freq=nullif(@carrier_freq,''),
effective_erp=nullif(@effective_erp,''),
electrical_deg=nullif(@electrical_deg,''),
elev_amsl=nullif(@elev_amsl,''),
Z_elev_bldg_ag=nullif(@Z_elev_bldg_ag,''),
Z_gain_area=nullif(@Z_gain_area,''),
haat_rc_mtr=nullif(@haat_rc_mtr,''),
hag_overall_mtr=nullif(@hag_overall_mtr,''),
hag_rc_mtr=nullif(@hag_rc_mtr,''),
horiz_bt_erp=nullif(@horiz_bt_erp,''),
lat_deg=nullif(@lat_deg,''),
lat_min=nullif(@lat_min,''),
lat_sec=nullif(@lat_sec,''),
lon_deg=nullif(@lon_deg,''),
lon_min=nullif(@lon_min,''),
lon_sec=nullif(@lon_sec,''),
Z_loss_area=nullif(@Z_loss_area,''),
Z_max_ant_pwr_gain=nullif(@Z_max_ant_pwr_gain,''),
max_erp_dbk=nullif(@max_erp_dbk,''),
max_erp_kw=nullif(@max_erp_kw,''),
max_haat=nullif(@max_haat,''),
mechanical_deg=nullif(@mechanical_deg,''),
multiplexor_loss=nullif(@multiplexor_loss,''),
power_output_vis_dbk=nullif(@power_output_vis_dbk,''),
power_output_vis_kw=nullif(@power_output_vis_kw,''),
Z_predict_coverage_area=nullif(@Z_predict_coverage_area,''),
Z_predict_pop=nullif(@Z_predict_pop,''),
tilt_towards_azimuth=nullif(@tilt_towards_azimuth,''),
true_deg=nullif(@true_deg,''),
upperband_freq=nullif(@upperband_freq,''),
vert_bt_erp=nullif(@vert_bt_erp,''),
visual_freq=nullif(@visual_freq,''),
rcamsl_horiz_mtr=nullif(@rcamsl_horiz_mtr,''),
ant_rotation=nullif(@ant_rotation,''),
input_trans_line=nullif(@input_trans_line,''),
Z_max_erp_to_hor=nullif(@Z_max_erp_to_hor,''),
trans_line_loss=nullif(@trans_line_loss,''),
lottery_group=nullif(@lottery_group,''),
analog_channel=nullif(@analog_channel,''),
Z_lat_whole_secs=nullif(@Z_lat_whole_secs,''),
Z_lon_whole_secs=nullif(@Z_lon_whole_secs,''),
max_erp_any_angle=nullif(@max_erp_any_angle,''),
station_channel=nullif(@station_channel,''),
site_number=nullif(@site_number,''),
elevation_antenna_id=nullif(@elevation_antenna_id,'')
;
